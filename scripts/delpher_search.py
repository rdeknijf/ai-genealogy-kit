...
Usage:
    python scripts/delpher_search.py "de Vries"
    python scripts/delpher_search.py "de Vries" --type familiebericht
    python scripts/delpher_search.py "van der Kant Schijndel" --coll ddd --limit 10
    python scripts/delpher_search.py "de Vries" --sort date --order asc
"""
