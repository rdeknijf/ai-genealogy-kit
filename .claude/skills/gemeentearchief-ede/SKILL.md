...
python scripts/openarchieven_search.py "de Vries" --archive gae \
...
1. `Jansen` across Ede municipality: 132 records, covering 1844 through 1952
2. `de Vries` + `BS Geboorte` + `1890-1895`: 14 matched birth acts in Ede
3. Record `gae:7CEDC33B-96B3-40CC-8848-FD0D0D5EA43F`: Aaltje de Vries,
   born 4-11-1891 Ede
