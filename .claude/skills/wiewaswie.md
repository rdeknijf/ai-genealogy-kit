...
|-----------|-------------|---------|
| name | Search query (supports year: "de Vries 1848") | de Vries |
| name | Year range in name | de Vries 1848-1900 |
...
**Example:** Hendrik Peters (b. 1767) is indexed as "Hendrik Aarts Peters" --
patronymic "Aarts" (son of Aart) + variant spelling "Peters". Searching for
surname "Peters" returns zero results.
...
|-------------|---------|----------------|
| Hendrik Aarts Peters | Hendrik, son of Aart Peters | Peters |
| Aart Rijkse | Aart, son of Rijk | Peters |
| Rijk Aarts | Rijk, son of Aart | Peters |
| Aert Isacks | Aert, son of Isaac | Peters |
| Jan Riksen | Jan, son of Rijk | Peters |

The surname "Peters/Peters/Petersen" appears intermittently alongside patronymics.
Church records may use surname, patronymic, or both depending on the minister.

### Verified results

This technique found 4 baptism records in the Peters line (1666-1767) that
