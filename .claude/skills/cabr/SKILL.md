...
## Example — Jansen search (verified 2026-04-11)
...
- Albertus Antonius Jansen (1909-05-04, 's-Gravenhage) — identifier 299993
- ... plus seven more
...
2. **Never publish dossier content** (photographs, accusation text, NSB
   ...
   (`genealogy.example.com`) must not expose CABR content.
