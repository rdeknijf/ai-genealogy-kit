...
description: |
  ...
  Contains 1,108+ Jansen person records across multiple published trees
  including "Stamboom De Vriesf en verwanten", "Genealogie Van der
  Mersch-De Vriesf", "Stamboom Glasmeier-Buhrs", and many others. This
...
- **Genealogie Verkroost** — Jan Jans Jansen (1720)

Top first names: Jan, Arend, Maria, Pieter, Arie, Cornelia, Cornelis,
Gerrit, Elisabeth, Neeltje, Teuntje, Jan.
...
```bash
curl -s "https://www.genealogieonline.nl/zoeken/?q=jansen&vn=gijsbert&gv=1700&gt=1800&t=person&output=json&ta=100"
```
...
Example: all Jansen records in Genealogie Mostert (publication 33):

```
https://www.genealogieonline.nl/zoeken/?q=jansen&publication=33&t=person&output=json&ta=100
```
...
```
browser_navigate → https://www.genealogieonline.nl/zoeken/?q=jansen&t=person
```
...
- **Open Archieven** — official archive records (7,750 Jansen records)
- **Stamboom Forum** — 17 people researching Jansen, 63 forum posts
- **Stamboom Gids** — 3 websites about Jansen
