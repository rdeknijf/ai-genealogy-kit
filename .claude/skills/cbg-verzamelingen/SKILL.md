...
```
# Family announcements for "Jansen"
WebFetch -> https://cbgverzamelingen.nl/zoeken?view=cbgsearch&search=Jansen&collection=Familieadvertenties

# Family dossiers for "van den Berg"
...
# Page 2 of results
WebFetch -> https://cbgverzamelingen.nl/zoeken?view=cbgsearch&search=Jansen&collection=Familieadvertenties&start=50
```
...
- Tussenvoegsel (prefix) is part of the search term — search "de Vries" or "Jansen"
