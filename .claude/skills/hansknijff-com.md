...
description: |
  ...
  covering the Knijff/de Knijf/van der Knijff family. Use when: researching Knijff
...
## IMPORTANT: Frameset Navigation

The site uses old-style HTML framesets. URLs containing "frameset" return only
layout code with no genealogical data. Always strip "frameset" from the URL to
get the actual content page.

Example:

- BAD: `familie knijff-000994-pframeset.htm?familie knijff-000994-p.htm`
- GOOD: `familie knijff-000994-p.htm`

Pattern: take the filename after the `?` in the frameset URL.
...
| Stamreeks Hans | `https://hansknijff.com/stamboom%20knijff/familie%20knijff-000069-0-s.htm` |
| Stamreeks Martha | `https://hansknijff.com/stamboom%20knijff/familie%20knijff-000082-0-s.htm` |

### Related Families

| Section | Content URL |
|---------|------------|
| Familie Achterberg | `https://hansknijff.com/achterberg/familie%20knijff-000851-p.htm` |
| Familie van der Vloedt | `https://hansknijff.com/vloed/familie%20knijff%202013-000978-p.htm` |
| Familie Bos | `https://hansknijff.com/bos/familie%20knijff-000759-p.htm` |
...
| Documents archive (page 4) | `https://hansknijff.com/dossiers/page4.html` |
...
Different Knijff family from Gijsbert Knijff (~1620, Reijerscop). Catholic
...
143+ digitized primary sources across 4 pages, 1600–2008. Includes:
notarial acts, baptism/marriage/death records, transport acts, VOC crew
lists, guardianship documents, family registers, photos. Most from Woerden
regional archive (W054 series).

## Key Connection to de Knijf
