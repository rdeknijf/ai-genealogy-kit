...
description: |
  ...
  "distribution of de Vries", "surname variants", "familienamen", "/cbg-familienamen",
...
after the base name: "Jansen, de" (not "de Vries"). The `gba_naam` uses natural
order: "de Vries".
...
- 2007 bearer count (per capitalization variant, e.g., "de Vries" vs "de Vries")
