...
```bash
playwright-cli -s=geneanet goto "https://en.geneanet.org/fonds/individus/?go=1&nom=Bakker"
playwright-cli -s=geneanet snapshot
```

The resulting page title becomes `Individual : BAKKER - Search all
...
```
https://en.geneanet.org/fonds/individus/?sexe=&nom=Bakker&prenom=&prenom_operateur=and&place__0__=Enkhuizen&type_periode=between&from=1800&to=1850&go=1
```

**Narrowing example** — Bakker in Enkhuizen, 1800–1850:

```
https://en.geneanet.org/fonds/individus/?go=1&nom=Bakker&place__0__=Enkhuizen&type_periode=between&from=1800&to=1850
```

This takes the unfiltered 4,353 Bakker hits down to 134 — strong
...
```
https://en.geneanet.org/fonds/individus/?go=1&nom=Bakker&page=2
https://en.geneanet.org/fonds/individus/?go=1&nom=Bakker&page=436
```
...
# Peters / Yates — Scottish connection research
playwright-cli -s=geneanet goto "https://en.geneanet.org/fonds/individus/?go=1&nom=Peters"
```
