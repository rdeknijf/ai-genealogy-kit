...
|---|---|---|
| `q` | Full-text search | `Bakker`, `Jan+Uijtenhooren` |
...
```bash
# All Bakker in DTB Dopen
curl -s "https://webservices.memorix.nl/genealogy/person?apiKey=eb37e65a-eb47-11e9-b95c-60f81db16c0e&q=Bakker&fq=search_s_register_type_title:%22DTB+Dopen%22&rows=25&page=1&sort=order_i_datum+asc"
