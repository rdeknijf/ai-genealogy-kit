...
```bash
python scripts/openarchieven_search.py "Peters" --archive ran --limit 10
python scripts/openarchieven_search.py "Jansen" --archive ran --limit 5
...
- **Peters research (RQ-001)** — the Nijmegen-Barneveld family. DTB Trouwen from
  the 1600s is where the Peters marriages would be recorded.
