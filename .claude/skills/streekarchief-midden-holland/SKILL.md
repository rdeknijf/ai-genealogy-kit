...
description: |
  ...
  Inschrijvingaktes. 36 Jansen results found, including Jan de Vries
  records in Gouda and van der Jansen in Waddinxveen. Scans available for
...
**Jansen records:** 36 results — de Vries in Gouda/Haastrecht, van der
Jansen in Noord-Waddinxveen/Broek/Moerkapelle, Jansen in Gouda/Schoonhoven/
Waddinxveen/Vlist.
...
```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=99a56f3a-da0b-11e9-9805-d77cd3614b0e&q=Jansen&rows=25'
```
  ...
  "person": [
    {
      ...
      "metadata": {
        ...
        "person_display_name": "Jan de Vries",
        "has_assets": "deed"
      }
    }
  ]
...
```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=99a56f3a-da0b-11e9-9805-d77cd3614b0e&q=*:*&fq=search_t_geslachtsnaam:%22Jansen%22+AND+search_t_voornaam:%22Jan%22&rows=25'
```
...
|-------|-------------|---------|
| `search_t_geslachtsnaam` | Surname | `"Jansen"` |
| `search_t_voornaam` | First name | `"Jan"` |
...
```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=99a56f3a-da0b-11e9-9805-d77cd3614b0e&q=Jansen&fq=search_s_deed_type_title:%22Geboorteakte%22&rows=25'
```

**Filter by municipality:**

```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=99a56f3a-da0b-11e9-9805-d77cd3614b0e&q=Jansen&fq=search_s_register_gemeente:%22Gouda%22&rows=25'
```
...
```
https://samh.nl/bronnen/genealogie/persons?ss={"q":"Jansen"}
```
