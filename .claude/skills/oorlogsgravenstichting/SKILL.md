...
**Primary use case for this tree:** Herman Jansen (WWII fatality research) and
...
OR semantics, so `"Herman Jansen"` will surface any Herman OR any Jansen. For
...
`https://oorlogsgravenstichting.nl/personen/80307/example-person`.
