...
description: |
  ...
  Stand, Bevolkingsregister, and Notariele Akten. Known to have "de Vries" /
  "van der Jansen" records from Aarlanderveen and Benthuizen. Triggers on: "search
...
**Jansen records:** 863 total person results, mostly "de Vries" from
Aarlanderveen. 14 DTB results (all begraafinschrijvingen from Benthuizen and
Aarlanderveen -- "van der Jansen" branch). Zero doopinschrijvingen for Jansen.
...
```bash
curl -sk 'https://gemeentearchief.alphenaandenrijn.nl/components/com_maisinternet/maisi_ajax_proxy.php?mivast=105&mizig=100&miadt=105&miview=tbl&milang=nl&mip1=Jansen&mip2=de&mip5=Aarlanderveen&mibj=1800&miej=1850'
```
