...
description: |
  ...
  ITS tracing. Directly relevant for Herman Jansen (Neuengamme /
...
curl -c /tmp/arolsen.jar -b /tmp/arolsen.jar \
  ...
  -d '{"uniqueId":"abc123","lang":"en","archiveIds":[],"strSearch":"Jansen","synSearch":true}'
```
...
## Verified example — Jansen search

18 Jansen persons found including:

- **Cornelius EXAMPLE** b. 23 Apr 1923, Amsterdam — signature
...
- **Theodorus EXAMPLE** b. 2 Aug 1920, prisoner #9331 — signature 1.1.1.2
  **Amersfoort Police Transit Camp** individual prisoner files.
- **Christianus EXAMPLE** b. 5 Mar 1907 — signature 2.1.1.1.

The Amersfoort transit camp series and forced-labor series both have
Jansen hits — directly relevant to the Herman Jansen hardening workflow.
