...
description: |
  ...
  Achttienhoven. Does NOT cover Alphen aan den Rijn. 398+ Jansen person records
...
```
https://www.erfgoedleiden.nl/collecties/personen/zoek-op-personen?ss={"q":"Jansen"}
```
...
```
https://www.erfgoedleiden.nl/collecties/personen/zoek-op-personen/persons?f={"search_s_deed_type_title":{"v":"DTB Dopen"}}&ss={"q":"Jansen"}
```
...
## Jansen records overview

The 398 Jansen records break down as:
- **BS Overlijden:** 128 (death certificates)
- **BS Geboorte:** 113 (birth certificates)
- **BS Huwelijk:** 79 (marriage certificates)
- **DTB Dopen:** 27 (baptisms, mostly Leiden branch — Arie/Abraham Jansen)
...
The Leiden DTB records appear to be a separate "de Vries" branch (Abraham de
Jansen, Arie Jansen) centered in Leiden, NOT the Woerden patrilineal line.
