...
description: |
  ...
  and Achttienhoven. Does NOT cover Alphen aan den Rijn. 398+ Jansen person
...
**Municipalities with Jansen records:** Ter Aar (179), Leiden (75), Nieuwkoop
...
```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=3288aeb2-c2a5-40b4-941b-f9beb2089511&q=jansen&rows=25'
```
  ...
  "person": [
    {
      ...
      "metadata": {
        ...
        "person_display_name": "Cornelia Jansen",
        "datum": 18710307,
        "has_assets": "deed"
      }
    }
...
```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=3288aeb2-c2a5-40b4-941b-f9beb2089511&q=jansen&fq=search_s_deed_type_title:%22BS+Geboorte%22&rows=25'
```

**Filter by municipality:**

```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=3288aeb2-c2a5-40b4-941b-f9beb2089511&q=jansen&fq=search_s_register_gemeente:%22Ter+Aar%22&rows=25'
```

**Combine multiple filters (AND):**

```bash
curl -s 'https://webservices.memorix.nl/genealogy/person?apiKey=3288aeb2-c2a5-40b4-941b-f9beb2089511&q=jansen&fq=search_s_deed_type_title:%22BS+Geboorte%22+AND+search_s_register_gemeente:%22Ter+Aar%22&rows=25'
```
...
```
https://www.erfgoedleiden.nl/collecties/personen/zoek-op-personen/persons?ss={"q":"Jansen"}
```
