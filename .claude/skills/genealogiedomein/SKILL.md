...
## Workflow: browsing the Didam NH doopboek (RQ-014 Bakker)
...
Guurtje, registered under patronymic "Jansen" not surname "Bakker".
...
Specifically for the Bakker lookup (RQ-014), ask for any entry where
the father is recorded as "Jan Gerritsen", "Jan Gerrits", "Jan",
"Johannes", or similar with mother "Guetjen", "Goetjen", "Guurtje",
"Gurtjen", or "Geurtje". The surname "Bakker" itself will almost
...
- **RK (Catholic) records are sparse on this site** — Baneman's focus
  ...
  **Relevant for RQ-014 (Bakker/Didam): Didam was predominantly
