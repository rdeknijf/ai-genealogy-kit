...
- **Why:** Factory personnel records for Doetinchem foundries (DRU etc.). Jacob de Vries worked as vormer (molder) there ~1914-1918. Very niche.
...
## Vorden NDG baptism register (pre-1674) — unindexed pages for Bakker family
...
- **Discovered:** 2026-04-10, F-1360/F-1361 (Bakker research session 3)
